<template>
  <div>
    ...
    <el-table :data="filteredData" :default-sort="{ prop: 'date', order: 'descending' }" max-height="530" style="width: 100%;border-radius:10px;box-shadow: 0 0px 4px rgba(66, 66, 66, 0.2);">
