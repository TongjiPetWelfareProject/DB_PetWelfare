...
<template>
  ...
  <div class="right">
     ...
     <router-link to="/mypage">我的页面
        </router-link>
    </div>

</div>
      <!-- <div class="tableitem" v-if="showTitle">
        <img src="main_icon.jpg" style="height: 100px;width: 100px;margin-left: 20px;margin-right: 20px">
        <p class="welcome-text">宠物救助站</p>
      </div> -->
      <!-- <el-text class="welcome-text">Hello!</el-text> -->
<!--   <el-avatar :size="40" :src="circleUrl" style="margin-top: 1vh;margin-right: 1vw;" /> -->
